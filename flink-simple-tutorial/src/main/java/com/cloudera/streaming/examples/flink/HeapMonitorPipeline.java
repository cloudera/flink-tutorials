...
/**
 * Simple Flink example program for the tutorial that identifies patterns in the stream of java heap metrics, and
 * creates dummy alerts for them if they contain a certain mask.
 */
